...
export declare namespace retail_v2alpha {
    ...
    export class Resource$Projects$Locations$Catalogs$Branches$Products {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        setLocalInventories(params: Params$Resource$Projects$Locations$Catalogs$Branches$Products$Setlocalinventories, options: StreamMethodOptions): GaxiosPromise<Readable>;
        setLocalInventories(params?: Params$Resource$Projects$Locations$Catalogs$Branches$Products$Setlocalinventories, options?: MethodOptions): GaxiosPromise<Schema$GoogleLongrunningOperation>;
        setLocalInventories(params: Params$Resource$Projects$Locations$Catalogs$Branches$Products$Setlocalinventories, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        setLocalInventories(params: Params$Resource$Projects$Locations$Catalogs$Branches$Products$Setlocalinventories, options: MethodOptions | BodyResponseCallback<Schema$GoogleLongrunningOperation>, callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        setLocalInventories(params: Params$Resource$Projects$Locations$Catalogs$Branches$Products$Setlocalinventories, callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
        setLocalInventories(callback: BodyResponseCallback<Schema$GoogleLongrunningOperation>): void;
    }
    ...
    export interface Params$Resource$Projects$Locations$Catalogs$Branches$Products$Setlocalinventories extends StandardParameters {
        /**
         * Required. Full resource name of Product, such as `projects/x/locations/global/catalogs/default_catalog/branches/default_branch/products/some_product_id`. If the caller does not have permission to access the Product, regardless of whether or not it exists, a PERMISSION_DENIED error is returned.
         */
        product?: string;
